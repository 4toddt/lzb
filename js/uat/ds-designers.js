...
if (pagePath == "/content/design-services/meet-our-designers") {
    ...
    for (var i = 0; i < len; i++) {
        ...
        <div class='designer-block'>\
            <img src='https://www.la-z-boy.com" + designers[i].room + "' alt='" + designers[i].name + "&rsquo;s Room'>\
            <div class='designer group'>\
                <div class='designer-portrait'>\
                    <img src='https://www.la-z-boy.com" + designers[i].portrait + "' alt='" + designers[i].name + "&rsquo;s Portrait'>\
                </div>\
    ...
    for (var i = start; i < start + len; i++) {
        ...
        if (j != currentDesignerIndex) {
            designerHTML += "<a href='" + site + designers[j].page + "'><div class='wrapper'><img src='https://www.la-z-boy.com" + designers[j].portrait + "' alt='" + designers[j].name + "'><h3>" + designers[j].name + "</h3><p class='arrow-right'>View Portfolio</p></div></a>";
        }
    }
    //Load carousel
