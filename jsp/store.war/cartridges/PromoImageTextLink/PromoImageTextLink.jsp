		...
		<div class="content">
			<div class="col-1">
				...
				<c:if test="${not empty actionURLTextLink}">
					<a href="${actionURLTextLink}" aria-label="${contentItem.textLinkTitle}" tabindex="0">${contentItem.textLinkTitle}</a>
				</c:if>
				<c:if test="${not empty actionURLCTALink}">
					<a href="${actionURLCTALink}" class="button secondary-btn" aria-label="${contentItem.CTAButtonText}" tabindex="0">${contentItem.CTAButtonText}</a>
				</c:if>
			</div>
			<div class="col-2">
