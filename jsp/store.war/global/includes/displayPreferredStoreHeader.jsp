...
<%-- DMI-2903: Displayed store should be the current store --%> 
	<c:choose>
	...
	<c:when test="${ store != null }">
		...
		<a href="${pageContext.request.contextPath}/storeLocator/storeLocator.jsp" class="utility store" tabindex="0">
			<div class="store-name" data-store-id="${storeId}">${store.name}</div>
			...
			<div class="store-content">
				<div class="sub-nav clearfix">
					...
					<c:if test="${not empty storeURL}">
						...
						<a href="${storeURL}" id="visit-preffered-store" class="left" aria-label="${visitYourStore}" tabindex="0">${visitYourStore}</a>
					</c:if>
