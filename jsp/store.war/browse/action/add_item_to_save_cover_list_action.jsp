...
<dsp:page>
	...
	<dsp:setvalue bean="GiftlistFormHandler.addItemToGiftlist" value="true"/>
	<json:object prettyPrint="true">
	<json:property name="securityStatus" value="${securityStatus}" />
		<c:choose>
				...
				<dsp:droplet name="LZBWishListContainDroplet">
	    			 <dsp:param name="profile" bean="/atg/userprofiling/Profile" />
	    			  <dsp:param name="saveCoverRequest" value="true" />
	    			   <dsp:param name="iteminfo" param="favouriteiteminfo" />
						...
						<dsp:oparam name="false">
							...
							<json:object>
								<json:property name="message">
									<dsp:valueof value="Item is not added in Save cover list sucessfully" valueishtml="true"/>
								</json:property>
							</json:object>
							</json:array>
