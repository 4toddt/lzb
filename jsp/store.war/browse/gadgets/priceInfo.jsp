<%-- 
As this jsp is no more use any where because of which i'm removing it. There is another file in /pricing/priceInfo.jsp which use the same content as this file use
