...
<dsp:page>
  ...
  <dsp:getvalueof var="siteId" vartype="java.lang.String" param="siteId"/>
	...
	<dsp:getvalueof var="prodName" param="commerceItem.auxiliaryData.catalogRef.displayName"/>
	<dsp:getvalueof var="prodId" param="commerceItem.auxiliaryData.catalogRef.id"/>
...
<dsp:a href="${contextPath}${pdpurl}"></dsp:a>
      ...
      <c:choose>
          ...
          <c:choose>
            ...
            <c:when test="${not empty productThumbnailImageUrl}">
              ...
              <c:choose>
                ...
                <dsp:a href="${contextPath}${pdpurl}"> <img  src="<dsp:valueof param='httpServer'/><dsp:valueof param='product.smallImage.url'/>"
                        alt="${productName}"/></dsp:a> 
                </c:when>
            ...
            <c:otherwise>
            	<dsp:a href="${contextPath}${pdpurl}"><img  height="105" width="105" src="<dsp:valueof param='httpServer'/>/crsdocroot/content/images/products/small/MissingProduct_small.jpg"
                    width="85" height="85" alt="${productName}"></dsp:a> 
            </c:otherwise>
          </c:choose>
        </c:when>
        ...
        <c:otherwise>
          <c:choose>
            ...
            <c:when test="${linkImage == 'false'}">
              <dsp:a href="${contextPath}${pdpurl}"><img src="<dsp:valueof param='httpServer'/><dsp:valueof param='alternateImage.url'/>"
                   alt="${productName}"/></dsp:a>
            </c:when>
