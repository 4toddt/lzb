...
<%--	<c:set var="protocol" value ="http://"/>
	...
	<%-- 		<fmt:parseNumber var="lowestSalePrice" value="${productRecord['P_LowestSalePrice']}"/>
			...
			<%-- <span class="pdp-description-link">
				<dsp:getvalueof var="countcharacter" value="${storeConfig.numberOfCharacterInPDPdescripton}"/>
				<c:set var="descriptonString" value="${fn:substring(productRecord['sku.longDescription'], 0, countcharacter)}" />
					${descriptonString}...<a href="#pdpDescriptionBlock" class="underline"><fmt:message key="pdp.seeDescription" /></a>
			</span> --%>
			...
			<dsp:getvalueof var="currentDealerId" bean="/atg/userprofiling/ProfileTools.priceListId" />
			<dsp:getvalueof var="dealer" bean="PriceListManager.tempDealer" />
			...
			<div class="sticky-container">
				<div class="sticky">
					...
					<div class="right discontinued-product">
