...
<dsp:page>
  ...
  --%>
  <dsp:getvalueof var="cache_key" value="bp_fpti_cart_${productId}_${alternateImageId}_${linkImage}_${httpServer}_${siteId}"/>

  <c:if test="${not empty commerceItemId}">
    <dsp:getvalueof var="cache_key"  value="bp_fpti_cart_${commerceItemId}_${productId}_${alternateImageId}_${linkImage}_${httpServer}_${siteId}"/>
  </c:if>
