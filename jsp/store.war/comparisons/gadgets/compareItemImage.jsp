...
<dsp:page>
  ...
  --%>
  <dsp:getvalueof var="imageUrl" param="element.sku.smallImage.url"/>

  <c:choose>
    <c:when test="${not empty imageUrl}">
      <dsp:include page="/comparisons/gadgets/productImg.jsp">
        <dsp:param name="product" param="element.product"/>
        <dsp:param name="alternateImage" param="element.sku.smallImage"/>
