	...
	<dsp:getvalueof var="orderParam" param="order" />
		...
		<%-- commerceItemsForMenetate variable is set in /account/includes/orderedItemContents.jsp file --%>
			...
			<dsp:oparam name="outputStart">
				...
				{"purchaseId": "${orderParam.id}", "productId": "${skuIdVarForMonetate}","quantity": "${quantityVarForMonetate}", "unitPrice": "${unitPriceVarForMonetate}", "currency": "${currencyCode}"},</dsp:oparam><dsp:oparam name="outputEnd">]]);</script>
			</dsp:oparam>
		</dsp:droplet>
</dsp:page>