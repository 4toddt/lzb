	...
	<jsp:body>
		<section role="region" class="dsr" data-module="dsr form-validate" id="dsrContainer">
			...
			<section data-module="floating-form-labels">
				<dsp:form method="post" action="${pageContext.request.contextPath}/dsr.jsp" name="dsrForm" formid="dsrForm" id="dsrForm">
                	<p><fmt:message key="dsr.form.instructions"/></p>
             	 	
					<p class="required-key"><sup>*</sup><fmt:message key="dsr.form.requiredField"/></p>
					...
					<div class="field-group clearfix">
	                	<div class="field">
	                  		<div class="text">
	                  			<dsp:input iclass="requiredField move-label" id="dsrfName" name="fName" type="text" beanvalue="ContactUSFormHandler.requestForm.firstName" bean="ContactUSFormHandler.requestForm.firstName" />
	                        	<label for="fName"><fmt:message key="dsr.form.firstName"/><sup>*</sup></label>
	                     	</div>
	                 	</div>
	                  	<div class="field">
	                    	<div class="text">
	                    		<dsp:input iclass="requiredField move-label" id="dsrlName" name="lName" type="text" beanvalue="ContactUSFormHandler.requestForm.lastName" bean="ContactUSFormHandler.requestForm.lastName" />
	                     		<label for="lName"><fmt:message key="dsr.form.lastName"/><sup>*</sup></label>
	                    	</div>
	                	</div>
					</div>
					<div class="text">
						<dsp:input iclass="requiredField move-label" id="dsremail" name="email" type="email" beanvalue="ContactUSFormHandler.requestForm.email" bean="ContactUSFormHandler.requestForm.email" />
	                 	<label for="email"><fmt:message key="dsr.form.emailAddress"/><sup>*</sup></label>
					</div>
					<div class="text">
						<dsp:input iclass="requiredField move-label" id="dsraddress1" name="address1" type="text" beanvalue="ContactUSFormHandler.requestForm.address" bean="ContactUSFormHandler.requestForm.address" />
	                 	<label for="address1"><fmt:message key="dsr.form.address"/><sup>*</sup></label>
					</div>
					<div class="field-group clearfix">
	                	<div class="field">
	                     	<div class="text">
	                    		<dsp:input iclass="requiredField move-label" id="dsrcity" name="city" type="text" beanvalue="ContactUSFormHandler.requestForm.city" bean="ContactUSFormHandler.requestForm.city" />
	                ...
	                <dsp:getvalueof bean="ContactUSFormHandler.requestForm.state" var="selState"/>
	                 	...
	                 	<div class="field">
	                    	<div class="text">
	                        	...
	                        	<dsp:select name="stateSelect" iclass="requiredField move-label" id="dsrstateSelect" bean="ContactUSFormHandler.requestForm.state" nodefault="true">
	             	...
	             	<div class="field-group clearfix last-row">
	                	<div class="field">
	                    	<div class="text">
	                        	<dsp:input iclass="requiredField move-label" id="dsrpostal" name="postal" type="text" beanvalue="ContactUSFormHandler.requestForm.zipCode" bean="ContactUSFormHandler.requestForm.zipCode" />
	                          	<label for="postal"><fmt:message key="dsr.form.zipCode"/><sup>*</sup></label>
	                   		</div>
	              		</div>
	                 	<div class="field">
	                    	<div class="text">
	                        	<dsp:input iclass="requiredField move-label" id="dsrphoneNumber" name="phoneNumber" type="tel" beanvalue="ContactUSFormHandler.requestForm.phone" bean="ContactUSFormHandler.requestForm.phone" />
	              	...
	              	<div class="field-group last-row type-of-request">
						<div class="custom-radio">
							<dsp:input type="radio" value="access" id="dsraccess" name="typeOfRequest" bean="ContactUSFormHandler.requestForm.typeOfRequest" checked="true" />
							<label for="access"><fmt:message key="dsr.form.access"/></label>
						</div>
						<div class="custom-radio">
							<dsp:input type="radio" value="deletion" id="dsrdeletion" name="typeOfRequest" bean="ContactUSFormHandler.requestForm.typeOfRequest" />
							<label for="deletion"><fmt:message key="dsr.form.deletion"/></label>
						</div>
						<div class="custom-radio">
							<dsp:input type="radio" value="data" id="dsrcategoryOfData" name="typeOfRequest" bean="ContactUSFormHandler.requestForm.typeOfRequest" />
							<label for="categoryOfData"><fmt:message key="dsr.form.categoryOfData"/></label>
						</div>
						<div class="custom-radio">
							<dsp:input type="radio" value="stop of sale" id="dsrstopOfSale" name="typeOfRequest" bean="ContactUSFormHandler.requestForm.typeOfRequest" />
					...
					<div class="type-of-data-container">
						...
						<div class="field-group last-row type-of-data">
							<div class="custom-checkbox">
	                    		<dsp:input name="account" type="checkbox" id="dsraccount" value="Account" bean="ContactUSFormHandler.requestForm.account" />
	                          	<label class="no-show" for="account"><fmt:message key="dsr.form.account"/></label>
	                     	</div>
	                     	<div class="custom-checkbox">
	                    		<dsp:input name="product" type="checkbox" id="dsrproduct" value="Product" bean="ContactUSFormHandler.requestForm.product" />
	                          	<label class="no-show" for="product"><fmt:message key="dsr.form.product"/></label>
	                     	</div>
	                     	<div class="custom-checkbox">
	                    		<dsp:input name="marketing" type="checkbox" id="dsrmarketing" value="Marketing" bean="ContactUSFormHandler.requestForm.marketing" />
					...
					<div class="account-data-auth hide">
						...
						<div class="text additional-data">
							<dsp:input iclass="requiredField move-label" name="accountNames1" type="text" id="dsraccountName1" bean="ContactUSFormHandler.requestForm.accountName1" />
					...
					<div class="text additional-data additional-account-row hide">
						<dsp:input iclass="requiredField move-label" name="accountNames2" type="text" id="dsraccountName2" bean="ContactUSFormHandler.requestForm.accountName2" />
					...
					<div class="product-data-auth hide">
						...
						<div class="field-group additional-data clearfix">
				   			<div class="field">
				        		<div class="text">
				            		<dsp:input iclass="requiredField move-label" id="dsrproductName1" name="productName1" type="text" bean="ContactUSFormHandler.requestForm.productName1" />
				                	<label for="productName1"><fmt:message key="dsr.form.productName"/></label>
				             	</div>
				      		</div>
				         	<div class="field">
				            	<div class="text">
				             		<dsp:input iclass="move-label" id="dsrserialNumber1" name="serialNumber1" type="text" bean="ContactUSFormHandler.requestForm.serialNumber1" />
					...
					<div class="field-group additional-data additional-product-row clearfix hide">
				  		<div class="field">
				       		<div class="text">
				           		<dsp:input iclass="requiredField move-label" id="dsrproductName2" name="productName2" type="text" bean="ContactUSFormHandler.requestForm.productName2" />
				           		<label for="productName2"><fmt:message key="dsr.form.productName"/></label>
				        	</div>
				     	</div>
				    	<div class="field">
				        	<div class="text">
				          		<dsp:input iclass="move-label" id="dsrserialNumber2" name="serialNumber2" type="text" bean="ContactUSFormHandler.requestForm.serialNumber2" />
				 	...
				 	<div>
			      	...
			      	<div class="field-group additional-data additional-product-row clearfix hide">
			        	<div class="field">
			          		<div class="text">
			            		<dsp:input iclass="requiredField move-label" id="dsrproductName3" name="productName3" type="text"  bean="ContactUSFormHandler.requestForm.productName3" />
			            		<label for="productName3"><fmt:message key="dsr.form.productName"/></label>
			          		</div>
			         	</div>
			          	<div class="field">
			          		<div class="text">
			           			<dsp:input iclass="move-label" id="dsrserialNumber3" name="serialNumber3" type="text" bean="ContactUSFormHandler.requestForm.serialNumber3" />
	              	...
	              	<div class="delete-confirmation-container hide">
				     	...
				     	<p><fmt:message key="dsr.form.deleteConfirmation"/></p>
				       	<div class="text additional-data">
							<dsp:input iclass="requiredField move-label" id="dsrdelete" name="delete" type="text" bean="ContactUSFormHandler.requestForm.delete" maxlength="8" />
					...
					<div class="text textarea additional-data">
                    	<dsp:textarea iclass="move-label" name="comments" id="dsrcomments" bean="ContactUSFormHandler.requestForm.comments" />
					...
					<div class="captcha">
                  	...
                  	<div class="text verification-num">
                    	<input class="requiredField move-label" id="dsrverficationNum" name="verficationNum" type="text" />
                	...
                	<div class="custom-checkbox text legal-consent">
                  		<dsp:input type="checkbox" id="dsrlegal-consent" name="legalConsent" value="Yes" bean="ContactUSFormHandler.requestForm.legalStr" />
                   		<label for="legal-consent"><fmt:message key="dsr.form.legal"/></label>
                 	</div>
                 	
					<div>
                   		<dsp:input type="hidden" bean="ContactUSFormHandler.errorUrl" value="${pageContext.request.contextPath}/dsr.jsp?success=false"/>
                   		<dsp:input type="hidden" bean="ContactUSFormHandler.successUrl" value="${pageContext.request.contextPath}/dsr.jsp?success=true"/>
