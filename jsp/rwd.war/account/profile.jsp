<%--
	...
	- Copyright Notice:
	- Description: This is the profile page for My Account
	- Parameters:
	-
--%>
<dsp:page>
	...
	<layout:default>
		...
		<jsp:attribute name="analyticsPageType">accountProfilePage</jsp:attribute>
			...
			<div class="section-row">
				<div class="account-two-column-container">
					...
					<div class="account-two-column-right">
						<dsp:include page="/account/includes/profile_view.jsp"/>
						<div class="deactive-account">
							<p><fmt:message key="profile.DeactivateInfo"/></p>
							<dsp:a href="${contextPath}/account/deactivateAccount.jsp"><fmt:message key="profile.Deactivate"/></dsp:a>
						</div>
					</div>
				</div>
			</div>
