...
MediatorTest.prototype["test Mediator namespace"] = function () {
	expectAsserts(2);
	assertEquals("Mediator should exist in LZB namespace", "function", typeof LZB.Mediator);
	assertEquals("Mediator should not leak", "undefined", typeof Mediator);
};
MediatorTest.prototype["test Mediator constructor"] = function () {
	expectAsserts(2);
	assertTrue("Mediator should instantiate", (new LZB.Mediator()) instanceof LZB.Mediator);
	assertTrue("Mediator should instantiate without 'new'", (LZB.Mediator()) instanceof LZB.Mediator);
};
MediatorTest.prototype["test Mediator api"] = function () {
	expectAsserts(3);
	var mediator = new LZB.Mediator("mediator");
