...
(function (global, $, namespace) {
	...
	var CONSTANTS = global[namespace].constants,
			...
			loader = {
				init: function() {
					var loaderDiv = '<div class="loader"><div class="loader-backdrop fade"/><div class="loader-content"><img class="loader-animation" src="' + CONSTANTS.contextPath + '/resources/images/loading.gif" width="46" height="46" /><span class="loader-text">just a moment...</span></div></div>';
