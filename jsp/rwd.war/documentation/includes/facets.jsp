<section id="facet-docs" class="docs-section">
	...
	<div class="docs-example facet-example">
		<h4>Example</h4>
		<c:import url="/documentation/includes/facets-demo.jsp" />
			...
			<div class="facet-menu filters" data-filters>
				<div class="accordion" data-accordion aria-multiselectable="true">
					<div class="accordion-container">
						...
						<div class="facet-body accordion-body" aria-labeledby="category-facet-title" role="tabpanel" id="category-facet-body">
					...
					<div class="accordion-container">
						...
						<div class="facet-body accordion-body" aria-labeledby="color-facet-title" role="tabpanel" id="color-facet-body">
							<div class="accordion-body-content">
					...
					<div class="accordion-container">
						...
						<div class="facet-body accordion-body" aria-labeledby="size-facet-title" role="tabpanel" id="size-facet-body">
							<div class="accordion-body-content">
...
.facet-list {
	...
	&.links {
		.link-facet-items {
			...
			margin: 5px 0;
			&:hover {
				background: lighten($base-black, 70);
			}
		}
		.active {
			background: lighten($base-black, 30);
			color: $base-white;
			&:hover {
				background: lighten($base-black, 30);
			}
	...
	&.tiles {
		.tile-facet-items {
			...
			margin: 0 2% 2% 0;
			padding: 10px 0;
			color: lighten($base-black, 40);
			border: 1px solid $border-color;
			@include font-size(14px);
			font-weight: $bold;
			&:hover {
				background: lighten($base-black, 90);
				border: 1px solid transparent;	 		}
		}
		.active {
			background: lighten($base-black, 40);
			color: $base-white;
			&:hover {
				background: lighten($base-black, 40);
			}
