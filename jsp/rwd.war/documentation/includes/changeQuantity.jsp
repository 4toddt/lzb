...
.changeQuantity {
	...
	.quantity-group {
		float:left;
		border: 2px solid lighten($base-black, 40);
		@include rounded;
		@include no-select;
	}
	...
	.plus-icon, .minus-icon {
		...
		background: lighten($base-black, 80);
		cursor: pointer;
		float:left;
		padding: 5px 10px;
	...
	.plus-icon {
		border-right: 1px solid lighten($base-black, 40);
	}
	.minus-icon {
		border-left: 1px solid lighten($base-black, 40);
	}
	.current-quantity {
		float:left;
	}
