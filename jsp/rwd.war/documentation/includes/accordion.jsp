...
<format:prettyPrint>
	...
	<p>The accordion behavior is automatically applied to elements with the data-accordion attribute. Otherwise you can
		...
		in the html markup by setting <code>aria-multiselectable</code> on the accordion element.</p>
	<h4 >JavaScript</h4>
...
//  };
	...
	<div class="docs-example">
		...
		<div class="accordion" id="js-accordion-example" aria-multiselectable="true">
			<div class="accordion-container">
				...
				<div class="accordion-body" aria-labeledby="accordion-title-1" role="tabpanel" id="accordion-content-1">
			...
			<div  class="accordion-container">
				...
				<div class="accordion-body" aria-labeledby="accordion-title-2" role="tabpanel" id="accordion-content-2">
					<div class="accordion-body-content">
