<section id="form-validation-docs" class="docs-section">
	...
	<p>We're using the validate plugin found in <code>lzb.validate.js</code>. Initialize the plugin by adding a <code>data-validate</code> attribute to the <code>form</code> element as shown below.</p>
		...
		<form data-validate>
			<div class="field-group">
				<div class="field">
					...
					<input id="firstName" name="firstName" type="text" placeholder="First Name" autocorrect="off" autocapitalize="on" data-validation="required"/>
				</div>
				<div class="field">
					<label for="lastName">Last Name</label>
					<input id="lastName" name="lastName" type="text" placeholder="Last Name"autocorrect="off" autocapitalize="on" data-validation="required"/>
				</div>
			</div>
			<div class="field-group">
			...
			<div class="field-group">
				...
				<select class="form-control" id="exampleSelect2"	data-validation="required">
				...
				<div class="field-group">
					...
					<div class="field">
						...
						<!-- The data-fieldname attribute allows you to add field-specific text in the error message
								"[data-fieldname] is required" is default empty field text but editable in lzb.validate.js -->
...
See plugin: lzb.validate.js
	...
	<p>Add custom validations (as testPattern checks) to the <code>rules</code> object in <code>lzb.validate.js</code>. Error message keys for all validations live in <code>jsConstants.js</code>. Don't forget to add any further custom validation rule messages here as well.</p>
