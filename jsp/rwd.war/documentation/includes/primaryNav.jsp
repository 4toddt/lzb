<section id="primary-nav-docs" class="docs-section">
	...
	<section class="primary-nav-item js-primary-nav-item">
		<h2 class="primary-nav-button js-primary-nav-button">
			<a href="#" class="nav-link">Hats</a>
		</h2>
		<ul class="primary-nav-menu js-primary-nav-menu">
		...
		<jsp:attribute name="htmlString">
			<div class="primary-nav" data-primarynav>
			  <nav>
			    ...
			    <section class="primary-nav-item js-primary-nav-item">...</section>
			    <section class="primary-nav-item js-primary-nav-item">...</section>
			  </nav>
			</div>
		</jsp:attribute>
