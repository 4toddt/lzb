	...
	<div class="docs-example">
		...
		<div class="tabs" data-tabs>
			...
			<div class="tabs-content">
				<div class="tab-body active" aria-labeledby="tab1panel" role="tabpanel" id="tab1panel">
					<div class="tab-body-content">
						<p>This is the first panel of the basic tab example. You can place all sorts of content here including a grid.</p>
					</div>
				</div>
				<div class="tab-body" aria-labeledby="tab2panel" role="tabpanel" id="tab2panel">
					<div class="tab-body-content">
						<p>This is the second panel of the basic tab example.</p>
					</div>
				</div>
				<div class="tab-body" aria-labeledby="tab3panel" role="tabpanel" id="tab3panel">
					<div class="tab-body-content">
	...
	<format:prettyPrint>
		<jsp:attribute name="htmlString">
			<div class="tabs" data-tabs>
				...
				<div class="tabs-content">
					<div class="tab-body active" aria-labeledby="panel1" role="tabpanel" id="tab1panel">
						<div class="tab-body-content">
							<p>This is the first panel of the basic tab example. You can place all sorts of content here including a grid.</p>
						</div>
					</div>
					<div class="tab-body" aria-labeledby="panel2" role="tabpanel" id="tab2panel">
						<div class="tab-body-content">
							<p>This is the second panel of the basic tab example.</p>
						</div>
					</div>
					<div class="tab-body" aria-labeledby="panel3" role="tabpanel" id="tab3panel">
						<div class="tab-body-content">
							<p>This is the third panel of the basic tab example.</p>
						</div>
					</div>
