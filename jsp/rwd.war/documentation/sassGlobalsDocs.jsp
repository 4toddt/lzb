...
<%-- Section and pageType --%>
<c:set var="section" value="home" />
<c:set var="pageType" value="" />


<%-- parameters for site mesh below --%>

<%-- HTML5 data attributes for JS hooks--%>
<content tag="jsController">home </content>
<content tag="jsAction"> </content>

<%-- CSS Hook --%>
<content tag="bodyClass">home</content>

<%-- Section and Subsection --%>
<content tag="section">${section}</content>
<content tag="pageType">${pageType}</content>
...
<pre class="prettyprint" style="display:block;">
.product_tile {
  @include box-shadow(1px 3px 10px #999);
}
</pre>
